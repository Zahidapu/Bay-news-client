    ...
    return (
        <div className="row">
            ...
            <div className="col-md-10">
                ...
                <input onBlur={handleBlur} type="name" name="name" className="form-control" placeholder="Jahid Apu" required />
                    <br />
                    <input onBlur={handleBlur} type="email" name="adminEmail" className="form-control" placeholder="zahidapu.a@gmail.com" required />
                    <br />
